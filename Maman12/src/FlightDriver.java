...
public class FlightDriver {
	public static void test() {
		...
		System.out
				.println("The number of passengers of the first Flight object is: " + firstFlight.getNoOfPassengers());
		...
		System.out.println(
				"Were 200 passengers added successfully to the first flight? " + firstFlight.addPassengers(200));
		System.out.println("The total price of the first flight is: " + firstFlight.totalPrice());
		System.out.println(
				"Does the first flight land before the second flight? " + firstFlight.landsEarlier(secondFlight));

...
public class Time1Driver {
	public static void test() {
		...
		System.out.println(
				"The minutes passed since midnight of the second Time1 object is: " + secondTime.minFromMidnight());
		...
		System.out.println(
				"The difference in minutes between the second and first time is: " + secondTime.difference(firstTime));

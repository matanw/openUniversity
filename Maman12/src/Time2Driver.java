...
public class Time2Driver {
	...
	public static void test() {
		...
		System.out.println(
				"The minutes passed since midnight of the second Time2 object is: " + secondTime.minFromMidnight());
		...
		System.out.println(
				"The difference in seconds between the first and second time is: " + firstTime.difference(secondTime));
